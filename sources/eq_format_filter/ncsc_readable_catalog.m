function [outData,pathname,flag] = ncsc_readable_catalog
%
...
for i = 1:length(myData)
	try 
            outData(i,1) = str2double(myData{i}(33:41));              % longitude
            outData(i,2) = str2double(myData{i}(24:31));             % latitude
            ...
            outData(i,7) = str2double(myData{i}(43:48));      % Depth             
