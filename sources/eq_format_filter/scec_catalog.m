function [outData,pathname,flag] = scec_catalog
%
...
for i = 1:length(myData)
	try 
             outData(i,1) = str2double(myData{i}(44:51));      % Longitude
             outData(i,2) = str2double(myData{i}(36:42));      % Latitude              
             outData(i,3) = str2double(myData{i}(1:4));        % Year
             outData(i,4) = str2double(myData{i}(6:7));        % Month
             outData(i,5) = str2double(myData{i}(9:10));       % Day
             outData(i,6) = str2double(myData{i}(27:30));      % Magnitude  
             outData(i,7) = str2double(myData{i}(53:57));      % Depth             
             outData(i,8) = str2double(myData{i}(12:13));      % Hour
             outData(i,9) = str2double(myData{i}(15:16));      % Minute
